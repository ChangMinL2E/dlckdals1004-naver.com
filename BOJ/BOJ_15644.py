...
def Backtracking(lst,Red, Blue, button, cnt):
    global minimum, result_lst
    ...
    # 오른쪽 경우 슈웃
    lst.append('R')
    Backtracking(lst,Red_right, Blue_right, button, cnt + 1)
    lst.pop()
    button = 0
    # 2. 왼쪽 / 열이 작은거부터,
    ...
    # 왼쪽 경우 슈웃
    lst.append('L')
    Backtracking(lst,Red_left, Blue_left, button, cnt + 1)
    lst.pop()
    button = 0
    # 3. 위쪽 경우
    ...
    # 위쪽 경우 슈웃
    lst.append('U')
    Backtracking(lst,Red_top, Blue_top, button, cnt + 1)
    lst.pop()
    button = 0
    # 4. 아래쪽 경우
    ...
    # 아래쪽 경우 슈웃
    lst.append('D')
    Backtracking(lst,Red_bottom, Blue_bottom, button, cnt + 1)
    lst.pop()
    button = 0
